      ...
      <div className="flex w-full w-screen h-[90vh]"> 
        ...
        <div className="w-1/2 bg-[#bce3f8] p-16 rounded-r-2xl flex flex-col justify-center">
          ...
          <p className="text-lg mb-4 text-center">
            ¿Aún no tienes cuenta? <a href="#" className="text-lg text-[#0000cc] block text-center mb-6">Registrarse</a>
          </p>
          ...
          {/* Botón */}
          <button className="w-full bg-[#4caf50] text-white font-bold py-2 mt-6 rounded-lg text-2xl">
            Ingresar
          </button>
        </div>
      </div>
